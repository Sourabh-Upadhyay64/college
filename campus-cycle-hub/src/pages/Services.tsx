...
import { ShoppingBag, MessageCircle, Shield, Zap, Users, Verified } from "lucide-react";
  ...
  const services = [
    {
      ...
      title: "Buy Bicycles",
      description:
        "Browse a wide selection of verified bicycles from fellow students. Filter by price, condition, type, and more to find your perfect ride.",
      features: [
        "Advanced search filters",
        "Detailed bicycle listings",
        "Photo galleries",
        "Price comparison",
      ],
    },
    {
      icon: Zap,
      title: "Sell Your Bicycle",
      description:
        "List your bicycle in under 2 minutes. Upload photos, set your price, and reach hundreds of potential buyers on campus instantly.",
      features: [
    ...
    },
    {
      ...
      description:
        "Join a growing community of student cyclists. Get tips, reviews, and recommendations from fellow campus bicycle enthusiasts.",
      features: [
        "Student reviews",
        "Seller ratings",
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Everything you need to buy, sell, and connect around bicycles on your campus
            </p>
          </div>
          ...
          <div className="mt-16 bg-gradient-primary text-white rounded-3xl p-8 md:p-12 text-center animate-fade-in-up">
            ...
            <p className="text-lg opacity-90 mb-8 max-w-2xl mx-auto">
              Join our trusted campus community and start buying or selling bicycles today
            </p>
